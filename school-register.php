...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (!$admin_name)  throw new Exception("Admin name is required.");
        ...
        if ($chk->get_result()->num_rows > 0) throw new Exception("This email is already registered.");

        $chk2 = $conn->prepare("SELECT id FROM school_users WHERE email=?");
        $chk2->bind_param('s', $email); $chk2->execute();
        if ($chk2->get_result()->num_rows > 0) throw new Exception("This email is already in use.");
        ...
        if (!$ins2->execute()) throw new Exception("Admin account creation failed.");
...
<head>
  ...
  <style>
    ...
    @media (max-width: 576px) { .reg-card { padding: 24px 18px; } }

    .field-group { margin-bottom: 18px; }
    .field-group label { font-size: .85rem; font-weight: 600; color: #374151; margin-bottom: 5px; display: block; }
    .field-group .form-control,
    .field-group .form-select { border-radius: 10px; padding: 10px 14px; font-size: .88rem; border-color: #e5e7eb; }
    .field-group .form-control:focus,
    .field-group .form-select:focus { border-color: #0C74C5; box-shadow: 0 0 0 3px rgba(12,116,197,.1); }

    .pass-wrap { position: relative; }
    .pass-wrap .toggle { position: absolute; right: 12px; top: 50%; transform: translateY(-50%); background: none; border: none; color: #9ca3af; cursor: pointer; padding: 0; font-size: .9rem; }

    .pw-bar { height: 4px; border-radius: 2px; background: #e5e7eb; margin-top: 6px; overflow: hidden; }
    .pw-bar-fill { height: 100%; border-radius: 2px; width: 0; transition: .3s; }

    .reg-divider { text-align: center; font-size: .72rem; color: #9ca3af; margin: 6px 0 18px; }
    .later-note { background: #f0fdf4; border: 1px solid #86efac; border-radius: 10px; padding: 10px 14px; font-size: .78rem; color: #166534; margin-bottom: 20px; }

    .benefit-row { display: flex; align-items: center; gap: 8px; font-size: .83rem; color: #374151; margin-bottom: 8px; }
    .benefit-row i { color: #16a34a; width: 16px; }
  </style>
</head>
<body>
  ...
  <div class="container">
    <div class="row justify-content-center align-items-start g-5">
      ...
      <div class="col-lg-4 col-md-5 d-none d-md-block">
        ...
        <a href="<?= BASE_URL ?>school-login.php" class="btn btn-outline-primary btn-sm w-100">Login to School Dashboard</a>
      </div>
      ...
      <div class="col-lg-5 col-md-7">
        <div class="reg-card">
          ...
          <div class="later-note">
            ...
            <strong>Quick sign-up:</strong> Fill in the essentials now. Logo, board, address & other details can be added from your school dashboard after approval.
          </div>
          ...
          <form method="POST" autocomplete="off">
            ...
            <div class="field-group">
              ...
              <input type="text" class="form-control" name="school_name"
                ...
                placeholder="e.g. Delhi Public School, Sector 12" required autofocus>
            </div>
            ...
            <div class="field-group">
              ...
              <div class="input-group">
                <span class="input-group-text" style="border-radius:10px 0 0 10px;"><i class="fa fa-envelope"></i></span>
                <input type="email" class="form-control" name="email"
                  value="<?= htmlspecialchars($_POST['email'] ?? '') ?>"
                  placeholder="principal@yourschool.edu.in" required
                  style="border-radius:0 10px 10px 0;">
              </div>
              <div style="font-size:.72rem;color:#9ca3af;margin-top:3px;">Used to log in and receive approval notification.</div>
            </div>
            ...
            <div class="field-group">
              ...
              <div class="pass-wrap">
                ...
                <button type="button" class="toggle" onclick="togglePw('pw1',this)"><i class="fas fa-eye"></i></button>
              </div>
            ...
            <div class="field-group">
              ...
              <div class="pass-wrap">
                ...
                <button type="button" class="toggle" onclick="togglePw('pw2',this)"><i class="fas fa-eye"></i></button>
              </div>
            ...
            <button type="submit" class="btn btn-primary w-100 py-2 fw-semibold" style="border-radius:10px;font-size:.95rem;">
