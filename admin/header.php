...
<nav class="sidebar vertical-scroll dark_sidebar ps-container ps-theme-default ps-active-y">
    ...
    <ul id="sidebar_menu" class="sidebar-menu mt-3">
        ...
        <!-- Appointments -->
        <li>
            <a class="has-arrow" href="#"><i class="fas fa-calendar-check" style="color: #44a6ad;"></i> <span>Appointments</span></a>
            <ul>
        ...
        <li>
            ...
            <ul>
                ...
                <li><a href="patient-records.php">Medical Records</a></li>
        ...
        <li>
            ...
            <ul>
                ...
                <li><a href="medical-history.php">Health History</a></li>
                <li><a href="upload-reports.php">Upload Reports</a></li>
            </ul>
        </li>

        <?php if ($is_admin): ?>
        <!-- Schools Module (Admin only) -->
        <li>
            <a class="has-arrow" href="#"><i class="fas fa-school" style="color: #0d6efd;"></i> <span>Schools</span>
                <?php
                $pending_schools = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as c FROM schools WHERE status='Pending'"));
                if ($pending_schools && $pending_schools['c'] > 0):
                ?>
                <span class="badge bg-danger ms-1" style="font-size:10px;"><?= $pending_schools['c'] ?></span>
                <?php endif; ?>
            </a>
            <ul>
                <li><a href="schools-list.php">All Schools</a></li>
                <li><a href="schools-list.php?status=Pending"><i class="fas fa-clock me-1 text-warning"></i> Pending Approvals</a></li>
                ...
                <li><a href="school-health-camps.php">Health Camps</a></li>
            </ul>
        </li>
        <?php endif; ?>
