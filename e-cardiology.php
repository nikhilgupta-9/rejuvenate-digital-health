  ...
  <section class="offer-banner container-fluid">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-md-3">
          <div class="offer-img">
            <img src="<?= BASE_URL ?>assets/img/doc.svg" alt="">
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="empty-state-wrapper">
                  ...
                  <div class="quick-links">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                      <a href="<?= BASE_URL ?>" class="small text-decoration-underline text-primary">Telemedicine</a>
                      <a href="<?= BASE_URL ?>" class="small text-decoration-underline text-primary">Health Checkups</a>
                      <a href="<?= BASE_URL ?>" class="small text-decoration-underline text-primary">Find Doctors</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="service-details-right-items">
                  ...
                  <div class="team-box-items-2">
                    <div class="team-image">
                      <!-- <img src="<?= BASE_URL ?>admin/<?= $doctor['profile_img'] ?>" alt="img"> -->
                    ...
                    <div class="creat-book">
                      ...
                      <a href="<?= BASE_URL ?>contact/" class="btn book-btn w-100 mt-2">Book an Appointment</a>
          ...
          <div class="col-lg-4 ">
            <div class="service-details-sidebar sticky-style">
              <div class="sidebar-card offer-card">
                ...
                <a href="<?= BASE_URL ?>contact/" class="btn book-btn w-100">Book Now</a>
              </div>
                ...
                <form>
                  ...
                  <div class="form-check mb-3">
                    ...
                    <label class="form-check-label small">
                      You hereby affirm & authorise Healthians to process the personal data as per the <a href="<?= BASE_URL ?>terms-and-condition/" class="text-danger">T&C</a>.
                    </label>
                  </div>
