            ...
            <div class="login-card">
              ...
              <form method="POST" action="">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                  ...
                  <small class="form-text"><a href="<?= BASE_URL ?>forgot-password/">Forgot Password?</a></small>
                </div>
                <button type="submit" class="btn btn-primary w-100">Login</button>
              </form>
              <p class="text-center mt-3 mb-0">Don't have an account? <a href="<?= BASE_URL ?>doctor-signup/">Sign Up</a></p>
            </div>
          </div>
        </div>
      </div>
