                ...
                <div class="col-md-3">
                    <div class="sidebar" id="sidebarMenu">
                        <div class="text-center info-content">
                            <img src="<?= BASE_URL . $doctor_profile_image ?>" class="userd-image">
                        ...
                        <a href="<?= BASE_URL ?>doctor/change-password.php" class="active">Change Password</a>
                    ...
                    <div class="profile-card shadow">
                        ...
                        <form method="POST" action="" id="passwordChangeForm">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="<?= BASE_URL ?>doctor/doctor-dashboard.php" class="btn btn-secondary">
                                    Cancel
                                </a>
                            </div>
                        </form>
