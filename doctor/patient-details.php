                            ...
                            <div class="profile-card shadow">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <h5 class="mb-3 mt-4" style="color:#00875a;"><i class="fas fa-heartbeat me-2"></i> ABHA Health ID</h5>
                                        <?php if (!empty($patient['abha_id'])): ?>
                                        <div style="background:#00875a;border-radius:12px;color:#fff;padding:16px 18px;margin-bottom:10px;">
                                            <div style="font-size:.58rem;opacity:.7;text-transform:uppercase;letter-spacing:.1em;margin-bottom:3px;">Ayushman Bharat Health Account</div>
                                            <div style="font-family:monospace;font-size:1rem;font-weight:700;letter-spacing:.08em;"><?= htmlspecialchars($patient['abha_id']) ?></div>
                                            <?php if (!empty($patient['abha_address'])): ?><div style="font-size:.75rem;opacity:.8;margin-top:3px;"><?= htmlspecialchars($patient['abha_address']) ?></div><?php endif; ?>
                                            <div class="d-flex align-items-center justify-content-between mt-2">
                                                <span style="font-size:.65rem;opacity:.65;"><i class="fas fa-calendar me-1"></i><?php if (!empty($patient['abha_linked_at'])): ?>Linked <?= date('d M Y', strtotime($patient['abha_linked_at'])) ?><?php endif; ?></span>
                                                <?php if (!empty($patient['abha_verified'])): ?>
                                                <span style="background:rgba(255,255,255,.2);border:1px solid rgba(255,255,255,.3);border-radius:20px;padding:2px 8px;font-size:.67rem;font-weight:700;"><i class="fas fa-shield-alt me-1"></i>Verified</span>
                                                <?php else: ?>
                                                <span style="background:rgba(255,165,0,.25);border-radius:20px;padding:2px 8px;font-size:.67rem;font-weight:700;"><i class="fas fa-link me-1"></i>Linked</span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div style="font-size:.75rem;color:#6b7280;padding:4px 2px;">
                                            <i class="fas fa-info-circle me-1"></i>This patient's ABHA is linked — their health records can be accessed digitally via the ABDM network.
                                        </div>
                                        <?php else: ?>
                                        <div style="background:#f9fafb;border:2px dashed #e5e7eb;border-radius:10px;padding:14px 16px;text-align:center;color:#6b7280;">
                                            <i class="fas fa-id-card fa-2x mb-2" style="opacity:.3;display:block;"></i>
                                            <div style="font-size:.82rem;">ABHA not linked for this patient.</div>
                                            <div style="font-size:.72rem;margin-top:4px;">Patient can link from their portal or admin can link manually.</div>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
