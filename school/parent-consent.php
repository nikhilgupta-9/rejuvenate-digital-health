...
/* ── Migration: add address fields to a table created before they existed ── */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_consent'])) {
    ...
    if (!$parent_name || !$student_name || strlen($parent_mobile) < 10) {
        ...
        $ins = $conn->prepare("INSERT INTO parent_consent_forms (token,school_id,school_name_manual,parent_name,relation,parent_mobile,parent_email,parent_aadhar_last4,student_name,student_dob,student_gender,student_class,student_section,student_roll_no,student_address,student_city,student_state,student_pincode,blood_group,known_allergies,existing_conditions,current_medications,consent_items,consent_given,declaration_text,ip_address,user_agent) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
        $ins->bind_param('sisssssssssssssssssssssisss', $token, $school_id, $school_manual, $parent_name, $relation, $parent_mobile, $parent_email, $aadhar_last4, $student_name, $student_dob, $student_gender, $student_class, $student_sec, $student_roll, $student_address, $student_city, $student_state, $student_pincode, $blood_group, $allergies, $conditions, $medications, $consent_json, $consent_given, $decl, $ip, $ua);
        if ($ins->execute()) {
            $success = true;
        } else {
...
<head>
    ...
    <style>
        ...
        @media (min-width: 992px) {
            ...
            .form-header { padding: 36px 24px 26px; }
            .form-header h1 { font-size: 1.7rem; }
            .form-header p { font-size: .95rem; }
        ...
        @media (max-width: 767px) {
            ...
            .form-header { padding: 24px 18px 18px; }
        ...
        @media (max-width: 575px) {
            .form-header { padding: 20px 14px 16px; }
            .form-header h1 {
                font-size: 1.2rem
            }
            .form-header p { font-size: .8rem; }
            .logo-badge { font-size: .7rem; padding: 4px 12px; }
        ...
        @media (max-width: 380px) {
            .form-header h1 { font-size: 1.05rem; }
            .logo-badge { font-size: .65rem; letter-spacing: .03em; }
        }
    </style>
</head>
...
<body>
    ...
    <div class="form-header">
        <div class="logo-badge"><i class="fas fa-heartbeat"></i> Rejuvenate Digital Health</div>
    ...
    <div class="consent-wrapper">
        ...
        <?php if ($success): ?>
            <div class="success-card">
                ...
                <h4 style="font-weight:700;color:var(--rdh-dark);">Consent Submitted!</h4>
                ...
                <a href="parent-consent.php"
                    style="display:inline-block;margin-top:18px;color:var(--rdh-blue);font-size:.84rem;"><i
            ...
            <form method="POST" id="cForm" novalidate>
                ...
                <div class="form-section">
                    <div class="section-head">
                        ...
                        <h5><i class="fas fa-school me-2" style="color:var(--rdh-blue)"></i>School Information</h5>
                    </div>
                ...
                <div class="form-section">
                    <div class="section-head">
                        ...
                        <h5><i class="fas fa-user me-2" style="color:var(--rdh-blue)"></i>Parent / Guardian Details</h5>
                    </div>
                    <div class="section-body">
                        <div class="row g-3">
                            <div class="col-md-6"><label class="form-label">Full Name <span
                                        class="req"></span></label><input type="text" name="parent_name"
                                    class="form-control" required placeholder="e.g. Ramesh Kumar"
                                    value="<?= htmlspecialchars($_POST['parent_name'] ?? '') ?>"></div>
                            <div class="col-md-6"><label class="form-label">Relation <span
                                        class="req"></span></label><select name="relation"
                            ...
                            <div class="col-md-6">
                                ...
                                <div style="font-size:.7rem;color:#94a3b8;margin-top:3px"><i
                                        class="fas fa-lock me-1"></i>Only last 4 digits stored</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    <div class="section-head">
                        ...
                        <h5><i class="fas fa-child me-2" style="color:var(--rdh-blue)"></i>Student Details</h5>
                    </div>
                    <div class="section-body">
                        <div class="row g-3">
                ...
                <div class="form-section">
                    <div class="section-head">
                        ...
                        <h5><i class="fas fa-notes-medical me-2" style="color:var(--rdh-blue)"></i>Medical History <span
                ...
                <div class="form-section">
                    <div class="section-head">
                        ...
                        <h5><i class="fas fa-clipboard-check me-2" style="color:var(--rdh-blue)"></i>I Give Consent For</h5>
                    </div>
                    <div class="section-body">
                            ...
                            <label class="consent-item" id="ci<?= $key ?>">
                                ...
                                <div>
                                    <div class="ci-title"><i class="<?= $icon ?>"
                                            style="color:var(--rdh-teal);width:15px"></i><?= $title ?></div>
                ...
                <div class="form-section">
                    <div class="section-head">
                        ...
                        <h5><i class="fas fa-pen-fancy me-2" style="color:var(--rdh-blue)"></i>Declaration</h5>
                    </div>
                    <div class="section-body">
                        ...
                        <label class="consent-item" style="border-color:#f59e0b;background:#fffbeb" id="ci_agree">
                            <input type="checkbox" name="i_agree" value="1" required
                                onchange="toggleCI('agree',this.checked)" <?= isset($_POST['i_agree']) ? 'checked' : '' ?>>
                        ...
                        <div style="font-size:.72rem;color:#94a3b8;margin-top:8px"><i class="fas fa-lock me-1"></i>Aadhaar
                            last 4 digits only — full number never stored. Submission is secured.</div>
                    </div>
                </div>
    ...
    <div class="form-footer"><i class="fas fa-shield-alt me-1"></i>Secured by Rejuvenate Digital Health  |  ABDM / ABHA
        Compliant  |  NHA India Guidelines</div>
    ...
    <script>
        ...
        function selAll(state) {
            document.querySelectorAll('.consent-item input[type=checkbox]').forEach(cb => {
                cb.checked = state;
        ...
        function updateProgress() {
            ...
            if (bar) bar.style.width = Math.round((filled / req.length) * 100) + '%';
        }
        document.querySelectorAll('#cForm input,#cForm select').forEach(el => el.addEventListener('change', updateProgress));
        document.querySelectorAll('.consent-item input:checked').forEach(cb => toggleCI(cb.closest('.consent-item').id.replace('ci_', ''), true));
        updateProgress();
    </script>
</body>
