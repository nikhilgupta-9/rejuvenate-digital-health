                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-5 wow fadeInUp" data-wow-delay=".3s">
                        <div class="team-image">
                            <img src="<?= BASE_URL ?>admin/assets/img/uploads/<?= $pro_details['pro_img'] ?>" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-7">
            ...
            <div class="about-wrapper-2">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="about-box-items">
                            <div class="number-content">
                                <img src="<?= BASE_URL ?>assets/img/icon4.png">
                    ...
                    <div class="col-md-4">
                        <div class="about-box-items">
                            <div class="number-content">
                                <img src="<?= BASE_URL ?>assets/img/icon5.png">
                    ...
                    <div class="col-md-4">
                        <div class="about-box-items">
                            <div class="number-content">
                                <img src="<?= BASE_URL ?>assets/img/icon6.png">
